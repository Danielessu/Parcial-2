...
async function cargarMenu() {
    try {
        const respuesta = await fetch("https://script.google.com/macros/s/AKfycbydI6tPg1QqF6KgN7IjGyjyt_cdd3aEzaOwza84eA9rRuh940gYBnGG7cVVLRZW5hNQTg/exec");
...
function enviarPedido() {
    ...
    fetch("https://script.google.com/macros/s/AKfycbylv-G1TWTRqcb4duQaiNpWgRsJPQxxN9SfS7Lk_46QFbnNztcDw9N0yFmxLppYGdye5g/exec", {
        method: "POST",
        headers: {
        ...
        .then(data => {
            ...
            showOrderMessage(`¡Tu pedido ${data.id} ha sido realizado con éxito! Gracias por elegir Santo Domingo.`);
            vaciarCarrito();
            cerrarFormulario();
        })
        .catch(error => {
